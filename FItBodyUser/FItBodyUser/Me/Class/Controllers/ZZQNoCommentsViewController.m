...
#define NO_COMMENTS_ID @"NOCOMMENTS_CELL"
@interface ZZQNoCommentsViewController ()<UITableViewDelegate, UITableViewDataSource>
...
//cell
@property(nonatomic, strong)ZZQNoCommentsTableViewCell * cell;
...
- (void)initForData{
    ...
    [query whereKey:@"orderStatus" equalTo:@"已收货"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    _cell = [tableView dequeueReusableCellWithIdentifier:NO_COMMENTS_ID];
    if (_cell == nil) {
        _cell = [[ZZQNoCommentsTableViewCell alloc] initWithStyle:UITableViewCellStyleValue1 reuseIdentifier:NO_COMMENTS_ID];
    }
