...
@interface ZZQAlreadyTableViewCell ()
...
@implementation ZZQAlreadyTableViewCell
...
- (void)initForCell{
    ...
    [_commentButton setTitle:@"已经完成" forState:UIControlStateNormal];
