...
#import "ZZQNoCommentsTableViewCell.h"
#import "ZZQOrderTemp.h"
#import "ZZQMerchant.h"

@interface ZZQNoCommentsTableViewCell ()
...
@implementation ZZQNoCommentsTableViewCell
...
- (void)initForCell{
    ...
    CGFloat btnW = 60;
    _commentButton = [[UIButton alloc] initWithFrame:CGRectMake(self.width-margin-btnW, self.height-margin-15, btnW, 20)];
    _commentButton.layer.borderWidth = 1;
    _commentButton.layer.borderColor = [UIColor colorWithRed:0.94 green:0.45 blue:0.26 alpha:1.00].CGColor;
    _commentButton.layer.masksToBounds = YES;
    _commentButton.layer.cornerRadius = 5;
    [_commentButton setTitle:@"我要评价" forState:UIControlStateNormal];
    _commentButton.titleLabel.font = [UIFont systemFontOfSize:11];
    [_commentButton setTitleColor:[UIColor colorWithRed:0.94 green:0.45 blue:0.26 alpha:1.00] forState:UIControlStateNormal];
...
- (void)commentAction:(UIButton *)btn{
    self.commentBlock(_order.objId, _index);
}
